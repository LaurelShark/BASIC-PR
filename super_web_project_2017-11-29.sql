...
# Generation Time: 2017-11-29 12:59:33 +0000
# ************************************************************
...
INSERT INTO `Question` (`id`, `text`, `answers`, `correct_answer_index`, `task_id`)
VALUES
	(1,'Правильна формула cosX','[\"sqrt(1-(sinX)^2)\", \"1-sinX\", \"1-(sinX)^2\"]',0,1),
	(2,'Правильна формула cosX','[\"sqrt(1-(sinX)^2)\", \"1-sinX\", \"1-(sinX)^2\"]',0,1),
	(5,'У світовій практиці існує дві моделі сегментації б','роздрібні',0,2),
	(6,'London is the capital of','UK',0,3),
	(7,'Яким би не був підхід до створення програмного заб','Яким би не був підхід до створення програмного забезпечення, кінцева програма має задовольняти деяким вимогам. Найчастіше зустрічаються',0,4),
	(8,'Ідентифікувати Відродження як самостійну історико-','Власне світоглядне обличчя доби. Культура Відродження суттєво змінила акценти в середньовічній «картині світу», розгорнула у своїй драматичній еволюції (від самоствердження до заперечення) відмінну ві',0,5),
	(9,'У відкритому 1928 в Харкові Українському Фізико-Те','Л. Ландау (Нобелівська премія 1962, головним чином за його теорію плинного гелію);',0,6),
	(10,'Хімічнний зв\'язок','це взаємодія між атомами, яка утримує їх у молекулі чи твердому тілі. Хімічний зв\'язок є результатом складної взаємодії електронів та ядер атомів і описуються квантовою механікою.',0,7),
	(11,'Метричний тензор','Знайдемо квадрат відстані {\\displaystyle ds} {\\displaystyle ds} між двома близькими точками многовиду:',0,8),
	(12,'Класифікація Gartner','Класифікація компанією Gartner програмних засобів типу BI базується на методі функціональних завдань, де програмні продукти кожного класу виконують певний набір функцій або операцій з використанням сп',0,9),
	(13,'Давньогрецькі колонії','Приблизно в VII ст. до н. е. греки почали закладати перші колонії на Північному Причорномор\'ї. Серед міст, що їх заснували греки, були: Тіра (в гирлі Дністра), Ольвія (на Південному Бузі), Херсонес (б',0,10),
	(15,'Кочові держави','',0,11),
	(16,'Синтезуючі дисципліни або теоретико-історичні — на','',0,12),
	(17,'Психологія часів Російської Імперії','',0,13),
	(18,'Германські мови','група споріднених мов індоєвропейської мовної родини. Мови германської групи у спілкуванні використовують понад 550 мільйонів людей. Найпоширеніші з них — англійська та німецька.',0,14),
	(19,'','',0,5);
